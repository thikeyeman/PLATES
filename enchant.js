...
(function() {
    ...
    enchant.Core = enchant.Class.create(enchant.EventTarget, {
        ...
        initialize: function(width, height) {
            ...
            if (!stage) {
                ...
                if (document.body.firstChild) {
                    document.body.insertBefore(stage, document.body.secondChild);
                } else {
        ...
        _oncoreresize: function(e) {
            this._element.style.width =  '960px';
            this._element.style.height =  '540px';
            this._element.style.bottom =  '3%';
            this._element.style.left =  '50%';
            this._element.style.transform =  'translateX(-22%)';
            var scene;
